...
export interface LoggerOptions {
     ...
     */
    stateTransformer?: (state: Record<string, any>) => Record<string, any>;
    /**
     * Transform action before print default: actn => actn
     */
    actionTransformer?: (actn: Record<string, any>) => Record<string, any>;
...
export interface LoggerColorsOption {
    title: (action: Record<string, any>) => string;
    prevState: (prevState: Record<string, any>) => string;
    action: (action: Record<string, any>) => string;
    nextState: (nextState: Record<string, any>) => string;
    error: (error: any, prevState: Record<string, any>) => string;
}
